...
export default function Products({ API_URL, isLoggedIn, token, filterName, setFilterName, setIsLoggedIn, setShowProfile, setModalEmail, modalEmail, products, currentPage, setCurrentPage, setProducts, setActiveCategory, activeCategory, setNoResult, noResult, setDemoUser }) {
